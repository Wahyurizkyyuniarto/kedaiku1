								...
								<div class="btn-group btn-group-toggle" data-toggle="buttons">
									...
									?>
									  <label class="btn btn-secondary">
										<input type="radio" name="jml" OnChange="resetjml()" value="<?php echo $qr['no_ukuran']; ?>" autocomplete="off" > <?php echo $qr['no_ukuran']; ?>
									  </label>
									<?php } ?>
								  <p><b> Kuantitas </b></p>
									  <div class="value-button" id="decrease" onclick="decreaseValue()" value="Decrease Value">-</div>
									  <input name="jum" type="number" id="number" value="1" max="5" required> 
