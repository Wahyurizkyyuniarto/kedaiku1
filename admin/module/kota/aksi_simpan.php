...
// query untuk menyimpan ke tabel tbl_kategori
    $querySimpan = mysqli_query($connection, "INSERT INTO kota (nama_kota) VALUES ('$namaKota')");
...
// jika query gagal, akan tampil alert dan halaman akan diarahkan ke form tambah kategori
        ...
        echo "<script> alert('Data  Gagal Dimasukkan'); window.location = '$admin_url'+'adminweb.php?module=tambah_kota';</script>";
    }
}
