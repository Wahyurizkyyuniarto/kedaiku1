						...
						<div class="bill-to">
							...
							<div class="form-one">
								...
								<form>
									...
									<input type="textarea" placeholder="Alamat Penerima" name="alamat_penerima">
									<!--<input type="text" placeholder="Kota" name="nama_kota">
							...
							<div class="form-two">
								...
								<form>
									...
									<select>
										...
										$querikota=mysqli_query($connection, "SELECT * FROM kota");
										while ($kota=mysqli_fetch_array($querikota)) {
											?>
										<option><?php echo $kota['nama_kota']; ?> </option>
										<?php } ?>
									</select>
									...
									<select>
											<?php 
										include "lib/koneksi.php";
										$querijasa=mysqli_query($connection, "SELECT * FROM jasa");
										while ($jasa=mysqli_fetch_array($querijasa)) {
											?>
										<option><?php echo $jasa['nama_jasa']; ?> </option>
										<?php } ?>
									</select>
										
									<input type="text" placeholder="Ongkir" name="biaya">
