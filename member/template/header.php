...
<head>
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="../asset/images/home/b_ico.ico">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="profile.php"><i class="fa fa-lock"></i><?php echo"$_SESSION[namauser]";?></a>
                                </li>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="active"><a href="produk.php">Shop</a>
                                </li> 
