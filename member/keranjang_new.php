				...
				<table class="table table-condensed">
					...
					<?php
						...
						for ($i=0; $i < $ses_total; $i++) {
							...
							$size	= $produk['ukuran']*$ses_jml[$i];
							$warna	= $produk['warna']*$ses_txt[$i];
							$total += $stotal;
							?>
							...
							<tr>
								...
								<td class="cart_delete">
									<a class="cart_quantity_delete" href="sessi.php?sts=delete&kode=<?=$ses_kode[$i]?>"
									onclick="return confirm('Yakin akan menghapus ?')"><i class="fa fa-times"></i></a>
								</td>
							</tr>
					...
					if(empty($_SESSION['pelanggan'])){
						...
						$link="proses_pesan.php?ttl=$total";
					}
					?>
